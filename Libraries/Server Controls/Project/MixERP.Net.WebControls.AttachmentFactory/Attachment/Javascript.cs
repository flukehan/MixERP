...
namespace MixERP.Net.WebControls.AttachmentFactory
{
    public sealed partial class Attachment
    {
        ...
        {
            string javascript = "var allowedExtensions='{0}'.split(',');var areYouSureLocalized = '{1}';var duplicateFileLocalized = '{2}';var invalidFileLocalized  = '{3}';var uploadedFilesDeletedLocalized = '{4}';";
            javascript = string.Format(CultureInfo.InvariantCulture, javascript, this.GetAllowedExtensions(), Messages.AreYouSure, Messages.DuplicateFile, Messages.InvalidFile, Messages.UploadFilesDeleted);
