...
namespace MixERP.Net.TransactionGovernor.Data.Verification
{
    public static class VerificationStatus
    {
        ...
        {
            return Factory.Get<Entities.Models.Transactions.Verification>("SELECT verification_status_id, office.get_user_name_by_user_id(verified_by_user_id) AS verified_by_user_name, verified_by_user_id, last_verified_on, verification_reason FROM transactions.transaction_master WHERE transaction_master_id=@0;", transactionMasterId).SingleOrDefault();
        }
    }
}