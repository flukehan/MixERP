...
namespace MixERP.Net.WebControls.StockTransactionViewFactory
{
    public partial class StockTransactionView
    {
        ...
        {
            JavascriptHelper.AddJSReference(this.Page, "MixERP.Net.WebControls.StockTransactionViewFactory.StockTransactionView.js", "stock_transaction_view", this.GetType());
        }
    }
}