...
signInButton.click(function () {
    ...
    var password = getPassword(username, passwordInputPassword.val(), window.challenge);
    ...
    ajaxAuthenticate.success(function (msg) {
        ...
        window.location = window.location.href.split('?')[0] + "?Message=" + msg;
    });
