...
using MixERP.Net.FrontEnd.Setup.Policy;
...
namespace MixERP.Net.FrontEnd.Services.Sales
{
    ...
    public class SalesOrder : System.Web.Services.WebService
    {
        ...
        public long Save(DateTime valueDate, int storeId, string partyCode, int priceTypeId, string referenceNumber, string data, string statementReference, string transactionIds, string attachmentsJSON)
        {
            ...
            return NonGlStockTransaction.Add("Sales.Order", valueDate, partyCode, priceTypeId, details, referenceNumber, statementReference, tranIds, attachments);
        }
