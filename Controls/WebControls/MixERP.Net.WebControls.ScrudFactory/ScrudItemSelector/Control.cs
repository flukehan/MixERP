...
namespace MixERP.Net.WebControls.ScrudFactory
{
    public partial class ScrudItemSelector : CompositeControl
    {
            ...
            using (HtmlTable table = new HtmlTable())
            {
                using (HtmlTableRow row = new HtmlTableRow())
                {
                    using (HtmlTableCell dropDownListCell = new HtmlTableCell())
                    {
                        ...
                        filterDropDownList.DataBound += FilterDropDownList_DataBound;
                    ...
                    {
                        using (Button goButton = new Button())
                        {
        ...
        private void LoadGridPanel(Panel gridPanel)
        {
            ...
            searchGridView.RowDataBound += SearchGridView_RowDataBound;
        ...
        private TemplateField GetSelectColumnTemplateField()
        {
            ...
            ITemplate itemTemplate = new MixERP.Net.WebControls.ScrudFactory.Helpers.ScrudItemSelectorSelectTemplate();
