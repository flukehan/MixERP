    ...
    $.jstree.plugins.search = function(options, parent) {
        ...
        this.search = function(str, skip_async, show_only_matches) {
            ...
            $.each(this._model.data, function(i, v) {
                /* MixERP Override Start */
                var menuCode = "";

                if (v.data && v.data.menucode) {
                    menuCode = v.data.menucode;
                }
                /* MixERP Override End */

                if (v.text && ((s.search_callback && s.search_callback.call(this, str, v)) || (!s.search_callback && f.search(menuCode /*v.text*/).isMatch)) && (!s.search_leaves_only || (v.state.loaded && v.children.length === 0))) {
                    r.push(i);
