...
namespace MixERP.Net.Web.UI.BackOffice.Controllers.Policy
{
    ...
    [RoutePrefix("policy/voucher-verification")]
    [Route("{action=index}")]

    public class VoucherVerificationController : ScrudController
    {
        public ActionResult Index()
        {
            const string view = "~/Areas/BackOffice/Views/Policy/VoucherVerification.cshtml";
        ...
        public override Config GetConfig()
        {
            Config config = ScrudProvider.GetScrudConfig();
            {
                ...
                config.Table = "voucher_verification_policy";
                config.ViewSchema = "policy";
                config.View = "voucher_verification_policy_scrud_view";
                ...
                config.Text = Titles.VoucherVerificationPolicy;
                config.ResourceAssembly = Assembly.GetAssembly(typeof(VoucherVerificationController));
