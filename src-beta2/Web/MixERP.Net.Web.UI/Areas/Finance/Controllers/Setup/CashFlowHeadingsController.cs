...
{
    [RouteArea("Finance")]
    [RoutePrefix("setup/cash-flow-headings")]
    [Route("{action=index}")]
    public class CashFlowHeadingsController : ScrudController
    {
       public ActionResult Index()
        {
            const string view = "~/Areas/Finance/Views/Setup/CashFlowHeadings.cshtml";
