...
namespace MixERP.Net.UI.ScrudFactory.Data
{
    public static class FormHelper
    {
        ...
        public static bool UpdateRecord(int userId, string tableSchema, string tableName, Collection<KeyValuePair<string, object>> data, string keyColumn, object keyColumnValue, string imageColumn, string[] exclusion)
        {
            if (data == null)
            {
                return false;
